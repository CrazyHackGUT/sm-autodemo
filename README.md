...
**P.S.**: In both cases, the plugin is compiled into the source folder. In the case of Linux, for everything to work, you must be in the folder with the compiler. Also if you use SM 1.10+, then it's better to use spcomp64.
